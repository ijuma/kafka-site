...
CAPITALIZED_REPO_NAME = "KAFKA_SITE"

# Location of the local git repository
REPO_HOME = os.environ.get("%s_HOME" % CAPITALIZED_REPO_NAME, os.getcwd())
...
GITHUB_BASE = "https://github.com/%s/%s/pull" % (GITHUB_USER, REPO_NAME)
GITHUB_API_BASE = "https://api.github.com/repos/%s/%s" % (GITHUB_USER, REPO_NAME)
JIRA_BASE = "https://issues.apache.org/jira/browse"
JIRA_API_BASE = "https://issues.apache.org/jira"
# Prefix added to temporary branches
TEMP_BRANCH_PREFIX = "PR_TOOL"

DEV_BRANCH_NAME = "asf-site"
